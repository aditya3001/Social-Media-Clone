...
const ProfilePage : NextPage<InferGetStaticPropsType<typeof getStaticProps>> = ({id})=>{
    ...
    return <>
        <Head>
            <title>{`Social Media Clone - ${profile.name}`}</title>
        </Head>
...
function FollowButton({userId, isLoading, isFollowing, onClick}: {userId: string, isLoading:boolean,isFollowing : boolean, onClick: ()=>void}){
